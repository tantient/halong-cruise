...
const translations: Record<Lang, Translations> = {
  vi: {
    ...
    about: {
      ...
      body: "Du thuyền của chúng tôi mang đến không gian riêng tư, dịch vụ cá nhân hóa và hành trình khám phá vịnh Hạ Long – Lan Hạ theo phong cách 6 sao. Mỗi khoảnh khắc trên tàu đều được thiết kế để bạn tìm lại sự cân bằng và phiêu lưu theo cách của riêng mình.",
      features: [
    ...
    form: {
      ...
      submit: "Gửi yêu cầu",
      success: "Đã gửi yêu cầu! Chúng tôi sẽ liên hệ bạn sớm.",
    },
    teaserForm: {
      label: "BÁO GIÁ SỚM",
      title: "Muốn nhận báo giá sớm?",
      subtitle: "Để lại thông tin, đội ngũ của chúng tôi sẽ gửi ưu đãi đầu tiên khi tàu chính thức khai trương.",
      name: "Họ tên",
      phone: "Số điện thoại",
      email: "Email",
      date: "Ngày dự kiến",
    ...
    recruitTeaser: {
      ...
      submit: "Gửi hồ sơ",
      success: "Đã nhận hồ sơ! Chúng tôi sẽ liên hệ bạn sớm.",
    ...
    offers: {
      ...
      subtitle: "Những ưu đãi được cập nhật theo mùa, giúp bạn tận hưởng hành trình với giá trị tốt nhất.",
      terms: "Điều kiện",
      cta: "Nhận ưu đãi",
    },
    careers: {
    ...
    contact: {
      ...
      formSubtitle: "Điền thông tin bên dưới, chúng tôi sẽ phản hồi trong vòng 24 giờ.",
      name: "Họ tên",
      phoneField: "Số điện thoại",
      subject: "Chủ đề",
      message: "Nội dung tin nhắn",
      submit: "Gửi tin nhắn",
      success: "Đã gửi tin nhắn! Chúng tôi sẽ liên hệ bạn sớm.",
    },
    footer: {
  ...
  en: {
    ...
    earlyAccess: {
      ...
      contactPlaceholder: "email@example.com",
      submit: "Notify me",
      success: "Thank you. We will reach out soon.",
      helper: "Your information is kept private.",
    },
    about: {
      label: "ABOUT CHRONOS",
      title: "The essence of bay-side luxury",
      body: "Our cruise offers private spaces, personalized service and curated voyages across Ha Long Bay and Lan Ha Bay in true six-star style. Every moment aboard is designed to help you rediscover balance and adventure on your own terms.",
      features: [
    ...
    teaserForm: {
      ...
      subtitle: "Leave your details and we will send the first offers when the cruise officially launches.",
      name: "Full name",
      phone: "Phone number",
      email: "Email",
      date: "Expected date",
    ...
    offers: {
      ...
      subtitle: "Seasonal offers updated regularly so you can experience the voyage at the best value.",
      terms: "Terms",
      cta: "Claim offer",
    },
    careers: {
    ...
    contact: {
      ...
      formSubtitle: "Fill in the form below and we will reply within 24 hours.",
      name: "Full name",
